      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          <h1 className="text-[40px] text-white font-semibold">
            Writing Code with Purpose, Managing Systems with
          ...
          <p className="text-gray-200 hidden md:block">
            Holla, I’m Irfan Nugroho, a passionate Junior Web Developer with a
            strong focus on backend development and cloud computing. While
            specializing in building fast, secure, and scalable solutions, I’m
            also actively expanding my skills to become a versatile Fullstack
            Developer.
          </p>
          <div className="flex-col md:flex-row hidden md:flex gap-5">
            <Link
              href="/CV-Irfan_Nugroho-2024.pdf"
